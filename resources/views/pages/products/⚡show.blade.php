    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <flux:card class="p-0 overflow-hidden">
                <div @class([
                    'aspect-square w-full flex items-center justify-center p-8',
                    'bg-gradient-to-br from-pink-50 via-rose-50 to-white dark:from-zinc-900 dark:via-zinc-900 dark:to-zinc-800' => $typeName === 'FRAGRANCE',
                    'bg-zinc-100 dark:bg-zinc-800/60' => $typeName !== 'FRAGRANCE',
                ])>

                    @if($typeName === 'FRAGRANCE')
                        {{-- Flacon de parfum, version décorative noir & rose --}}
